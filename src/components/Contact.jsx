...
const Contact = () => {
    const socialLinks = [
        ...
        },
        {
            ...
            icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22 12.073C22 6.505 17.523 2 12 2S2 6.505 2 12.073c0 4.997 3.657 9.13 8.438 9.881v-6.988H7.898v-2.893h2.54V9.838c0-2.506 1.492-3.89 3.775-3.89 1.095 0 2.239.196 2.239.196v2.458h-1.26c-1.24 0-1.625.772-1.625 1.564v1.881h2.773l-.444 2.893h-2.33v6.988C18.343 21.203 22 17.07 22 12.073Z" fill="currentColor" />
            </svg>,
            alt: 'Facebook'
        }
    ];
    ...
    return (
        <div id='contact' className='section'>
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a
                                ...
                                href={href}
                                target="_blank"
                                className='w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[backround-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80'
                            >{icon}</a>
                        ))}
                    </div>
                ...
                <form
                    action="https://getform.io/f/broygppa"
                    method='POST'
